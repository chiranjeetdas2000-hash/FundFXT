...
const SYMBOLS=Object.freeze(Object.fromEntries([
  ...FX.map(symbol=>[symbol,{pip:/JPY$/.test(symbol)?0.01:0.0001,contractSize:100000,spread:/JPY$/.test(symbol)?0.015:0.00015}]),
  ['XAUUSD',{pip:0.01,contractSize:100,spread:0.20}],
  ['XAGUSD',{pip:0.001,contractSize:5000,spread:0.02}]
]));
