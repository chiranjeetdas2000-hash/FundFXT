...
async function ensurePrimeChallengeConfig() {
  ...
  try {
    ...
    const rules = [
      ["PHASE_1", 500, 500, 1000, 2500, 3, 1, 0.01, 1.00, 100, 15, 0, 1, 3500, 15],
      ["PHASE_2", 400, 500, 1000, 2500, 3, 1, 0.01, 1.00, 100, 15, 0, 1, 3500, 15],
      ["PHASE_3", 300, 400, 800, 2500, 3, 1, 0.01, 1.00, 100, 15, 0, 1, 3500, 15],
