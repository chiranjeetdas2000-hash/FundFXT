...
function parseChallengeModel(input) {
  ...
  const mapping = {
    ...
    prime_5k: { model_key: "prime", size_key: "5k" },
    prime_10k: { model_key: "prime", size_key: "10k" },
    prime_15k: { model_key: "prime", size_key: "15k" },
    prime_20k: { model_key: "prime", size_key: "20k" },
    prime_25k: { model_key: "prime", size_key: "25k" },
...
async function ensurePrimeChallengeConfig() {
  ...
  try {
    ...
    const rules = [
      ["PHASE_1", 500, 500, 1000, 2500, 3, 1, 0.01, 1.00, 100, 10, 0, 1, 3500, 30],
      ["PHASE_2", 400, 500, 1000, 2500, 3, 1, 0.01, 1.00, 100, 10, 0, 1, 3500, 30],
      ["PHASE_3", 300, 400, 800, 2500, 3, 1, 0.01, 1.00, 100, 10, 0, 1, 3500, 30],
      ["FUNDED", 0, 400, 800, 2500, 3, 1, 0.01, 1.00, 100, 0, 0, 1, 0, 0],
    ];
...
app.get("/api/orders", authenticateToken, async (req, res) => {
  try {
    const [orders] = await db.execute(
      `SELECT request_id AS request_ref, id, model, original_amount_cents, discount_amount_cents, final_amount_cents, currency, status, created_at
