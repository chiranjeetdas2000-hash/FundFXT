(() => {
  ...
  function injectStyles(){if($('database-control-styles'))return;const s=document.createElement('style');s.id='database-control-styles';s.textContent='.db-layout{display:grid;grid-template-columns:280px minmax(0,1fr);gap:14px}.db-table-list{max-height:610px;overflow:auto}.db-table-item{width:100%;border:1px solid var(--border);background:var(--card);color:var(--text);padding:10px;border-radius:10px;display:flex;justify-content:space-between;text-align:left;margin:5px 0;cursor:pointer}.db-table-item.active,.db-table-item:hover{border-color:var(--green2,#00b56a)}.db-table-item span{display:flex;flex-direction:column;gap:2px}.db-table-item small{color:var(--muted)}.db-table-item strong{font-size:11px;color:var(--green2,#00b56a)}.db-grid-wrap{max-height:560px;overflow:auto}.db-grid-wrap table{min-width:900px}.db-grid-wrap td{max-width:260px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.db-actions{display:flex;gap:8px;flex-wrap:wrap}.db-schema{border:1px solid var(--border);border-radius:10px;padding:10px;margin-bottom:10px}.db-schema-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:8px}.db-schema-grid>div{padding:8px;border:1px solid var(--border);border-radius:8px;display:flex;flex-direction:column;gap:3px}.db-schema-grid span{font-family:monospace;font-size:11px}.db-schema-grid small{color:var(--muted)}.db-editor{position:fixed;inset:0;background:rgba(15,15,15,.72);backdrop-filter:blur(7px);-webkit-backdrop-filter:blur(7px);z-index:99999;padding:clamp(20px,6vh,72px) 18px;overflow-y:auto;overscroll-behavior:contain;display:flex;align-items:flex-start;justify-content:center}.db-editor[hidden]{display:none!important}.db-editor-card{width:min(100%,980px);max-height:88vh;overflow:auto;background:#fff;color:#161616;border:1px solid #d9dde3;border-radius:18px;padding:22px;box-shadow:0 30px 90px rgba(0,0,0,.42);position:relative;isolation:isolate}.db-editor-card .db-panel-head{position:sticky;top:0;z-index:2;background:#fff;border-bottom:1px solid #e7e9ed;margin:-22px -22px 18px;padding:18px 22px}.db-editor-card h3{color:#111;margin:0 0 4px}.db-editor-card small{color:#68707d}.db-editor-card .icon-btn{width:36px;height:36px;border:1px solid #d6dae0;background:#f7f8fa;color:#20242a;border-radius:9px;font-size:22px;line-height:1;cursor:pointer}.db-editor-card .icon-btn:hover{background:#eef0f3}.db-form-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:14px}.db-form-grid label{display:flex;flex-direction:column;gap:6px;font-size:12px;font-weight:600;color:#4f5865}.db-form-grid .input{width:100%;box-sizing:border-box;background:#fff;color:#171a1f;border:1px solid #cfd5dd;border-radius:9px;padding:10px 11px;outline:none}.db-form-grid .input:focus{border-color:#00a968;box-shadow:0 0 0 3px rgba(0,181,106,.12)}.db-form-grid .input:disabled{background:#f1f3f5;color:#8a919c;cursor:not-allowed}.db-editor-actions{display:flex;justify-content:flex-end;gap:10px;margin-top:20px;padding-top:16px;border-top:1px solid #e7e9ed}.db-editor-actions .btn{min-width:125px}.db-editor-card .btn.secondary{background:#f4f5f7;color:#252a31;border-color:#d5dae1}@media(max-width:900px){.db-layout{grid-template-columns:1fr}.db-table-list{max-height:260px}.db-form-grid{grid-template-columns:1fr}.db-editor{padding:12px}.db-editor-card{max-height:94vh;border-radius:14px;padding:16px}.db-editor-card .db-panel-head{margin:-16px -16px 14px;padding:14px 16px}.db-editor-actions{flex-direction:column-reverse}.db-editor-actions .btn{width:100%}}';document.head.appendChild(s)}
